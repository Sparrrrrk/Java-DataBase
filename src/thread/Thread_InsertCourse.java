...
public class Thread_InsertCourse implements Runnable{
...
//    private String userPort;
    ...
    public Thread_InsertCourse(CourseTable courseTable,String CourseInfo,OutputStreamWriter writer,InetAddress inetAddress)
    {
...
//        this.userPort = userPort;
    ...
    public void run() {
        ...
        try {
			String result = table.insertCourse(new Course(courseid,name,TotalSize,RemainSize));
