...
public class Thread_DeleteChoice implements Runnable{
...
//    private String userPort;
    ...
    public Thread_DeleteChoice(ChoiceTable choiceTable,String ChoiceInfo,OutputStreamWriter writer,InetAddress inetAddress) {
...
//        this.userPort = userPort;
    ...
    public void run() {
        ...
        try {
        	String result = table.deleteChoice(new Choice(Studentid,Courseid,time));
